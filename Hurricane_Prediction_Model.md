...
**Project description:** Analyze historical hurricane data to build predictive models for following purposes:
- determine whether or not a hurricane will go through "rapid intensifiation" in next 24 hours
- predict hurricane itensity in next 24 hours
- predict the total economic loss that will be created by a given hurricane

This project was in collaboration with NASA (JPL) to provide them a new predictive solutions.
...
Hurricane rapid intensification Forecast is the key to preventing damage caused by hurricane. The most damage is caused when a hurricane with low itensity suddenly intensifies as it lands on major cities. This model utilizes various machine learning algorithms to create an ensemble model to accurately predict whether or not a hurricane will go through RI in next 24 hours.
